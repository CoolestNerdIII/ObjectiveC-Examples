...
//Save Button and method
@property (strong, nonatomic) UIBarButtonItem *saveButton;
- (void)save;

//Back/Cancel Button and method
...
- (NSManagedObject *)addRelationshipObjectForSection:(NSInteger)section
{
    ...
    NSManagedObject *relationshipObject = [NSEntityDescription insertNewObjectForEntityForName:[destEntity name]
